...
const { data } = await createTask({ title: ..., description: ..., isCompleted: ..., });
...
// Variables can be defined inline as well.
const ref = createTaskRef({ title: ..., description: ..., isCompleted: ..., });
...
// Variables can be defined inline as well.
const { data } = await updateTask({ id: ..., title: ..., description: ..., isCompleted: ..., completedAt: ..., });
...
// Variables can be defined inline as well.
const ref = updateTaskRef({ id: ..., title: ..., description: ..., isCompleted: ..., completedAt: ..., });
